...
@Slf4j
@AllArgsConstructor
@Service("minivanVehicleService")
public class MinivanVehicleServiceImpl implements VehicleService{

  private final ParkRepository parkRepository;
  private final ParkService parkService;
  private final ModelMapper modelMapper;

  @Override public ParkDto checkOut(VehicleDto vehicleDto) throws ParkingLotException{
    try {
      Park park = parkService.parkingProcess(vehicleDto);
      park.setFee(((Minivan) park.getVehicle()).getMultiplier(park.getFee()));
